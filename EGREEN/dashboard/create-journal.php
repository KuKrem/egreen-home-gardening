            ...
            <nav>
              <ul class="metismenu" id="menu">
                ...
                <!-- <li class="active"> -->
                  ...
                  <li class="active" id="crejournalmi">
              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Create Journal</h4>
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Create new journal</h4>
                          <!-- <p>This system currently supports for colombo district. But your region will be added soon.</p> -->
...
<!-- -----------------------------create journal form starts----------------------------- -->
                          <form action="create-journal-save.php" method="post" id="addjourid" name="addjour">
                            <div class="form-group">
                              <label for="example-text-input" class="col-form-label">Journal name</label>
                              <input class="form-control" type="text" id="journid" name="jname" placeholder="Journal name">
                            </div>

                            <div class="col-md-3 col-lg-6">
                              <div class="form-control-feedback">
                                <span id="txtjourname"></span>
                              </div>
                            </div>                            
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" id="cropid" name="cropnm">
                                ...
                                <?php
                                  $getcrops="SELECT * FROM crops WHERE status=1";
                                  $rescrop=mysqli_query($conn, $getcrops); 
                                  foreach ($rescrop as $key => $crop) {                                 
                                ?>                                
                                <option value="<?php echo $crop['crop_id'] ?>"><?php echo $crop['cropname']; ?></option>
                                <?php } ?>
                              </select>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control" type="number" id="numofgid" name="numofg" placeholder="0">
                            </div>

                            <div class="col-md-3 col-lg-6">
                              <div class="form-control-feedback">
                                <span id="txtnumofger"></span>
                              </div>
                            </div>

                            <div class="form-group">
                              <label for="example-email-input" class="col-form-label">Select Region</label>
                              <div class="form-group row">
                                <div class="form-group col-md-4">
                                  ...
                                  <select class="form-control" id="provinceid">
                                    <option value="0">Select</option>
                                    <?php 
                                      $getprovinces="SELECT * FROM provinces WHERE status=1";
                                      $respro=mysqli_query($conn, $getprovinces);
                                      foreach ($respro as $key => $province) {
                                    ?>
                                    <option value="<?php echo $province['province_id'] ?>"><?php echo $province['pro_name']; ?></option>
                                    <?php } ?>
                                  </select>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                  <label class="col-form-label">Select Nearest Town</label>
                                  <select class="form-control" id="townid" name="reginame">
                                    <option value="0">Select</option>
                                    <!-- <option>Colombo</option>
                            ...
                            <button type="submit" id="creajourid" name="creajour" class="btn btn-primary mt-4 pr-4 pl-4">Create</button>
                          </form>
<!-- -----------------------------create journal form ends----------------------------- -->
    ...
    <script src="assets/js/create-journal-validate.js"></script>
