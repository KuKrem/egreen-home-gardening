                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Pending Users</h4>
...
<!-- ------------------------viewing pending users is_approved=0------------------------ -->
                            ...
                            <table id="dataTable2" class="text-center">
                              ...
                              <tbody>
                                <?php
                                  ...
                                  $userss=mysqli_query($conn, "SELECT * FROM `users` WHERE is_approved=0 ORDER BY role_id ASC");
                                        ...
                                        <div class="modal-content">                              
                                          ...
                                          <div class="modal-body">
                                            <div>               
                                              ...
                                              <?php
                                                $users="SELECT * FROM users WHERE is_approved=0 AND user_id=$uid";  
                                                $modalqry = mysqli_query($conn, $users);
                  ...
                  <!-- ---------------affected area ends--------------- -->
                                  ...
                                  <td><a href="user-approve.php?uid=<?php echo $uid;?>" class="btn btn-rounded btn-success mb-3 btn-sm">Approve</a></td>
                                </tr>
