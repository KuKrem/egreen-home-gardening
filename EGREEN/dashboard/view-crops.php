<?php
  ...
  $getcrops = "SELECT * FROM crops";
  $res = mysqli_query($conn,$getcrops);
 ?>
            ...
            <nav>
              <ul class="metismenu" id="menu">
                ...
                <!-- <li class="active"> -->
                  ...
                  <li class="active" id="viewcropsmi">
              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Crops</h4>
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Crops</h4>
...
<!-- --------------------------------Crop view table start-------------------------------- -->
                          <div class="data-tables datatable-primary">
                            <table id="dataTable2" class="text-center">
                              ...
                              <tbody>
                                <?php foreach ($res as $index => $crop) { ?>
                                <tr>
                                  <td><?php echo ++$index ?></td>
                                  <td><?php echo $crop['cropname'] ?></td>
                                  <td><a href="edit-crop.php?id=<?php echo $crop['crop_id'] ?>">
