              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Select Region</h4>
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Select your helping area</h4>
                          <p>You can select a region as you wish, to help planters. Planters will contact you when they find you.</p>
...
<!-- ------------------------Get crop names to the dropdown starts------------------------ -->
                          <form name="addhelrgfm" id="addhelrgfmid" action="select-region-save.php" method="post">

                            
                            <div class="row">
                              <div class="form-group col-lg-4">
                              <label class="col-form-label"><b>Select Province</b></label>
                              <select class="form-control form-fixer" name="selectpro" id="helppro">
                                <option value="0">Select One</option>
                                <?php foreach ($respro as $index => $province) { ?>
                            ...
                            <div class="form-group col-lg-4">
                              <label class="col-form-label"><b>Select District</b></label>
                              <select class="form-control form-fixer" name="selectdis" id="helpdis">
                                <option value="0">Select</option>                             
                              </select>
                            </div>

                            <div class="form-group col-lg-4">
                              <label class="col-form-label"><b>Select Nearest Town</b></label>
                              <select class="form-control form-fixer" name="selectreg" id="helpreg">
                                <option value="0">Select</option>                              
                              </select>
                            </div>
                            </div>                            

                            <button type="submit" id="addhelregid" name="addhelreg" class="btn btn-primary mt-4 pr-4 pl-4">Submit</button>
                          </form>
<!-- ------------------------Get crop names to the dropdown ends------------------------ -->
    ...
    <script src="assets/js/select-region-validate.js"></script>
