                ...
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                      <li><a href="view-crops.php">View Crops</a></li>
...
<!-- ----------------------------------crop add form starts---------------------------------- -->
                          <form action="add-crop-save.php" method="post" id="add_crop" name="add_crop">
                            <div class="form-group">
                              <label for="cropname" class="col-form-label">Crop name</label>
                              <input class="form-control" type="text" name="cropname" id="cropname">
                            </div>
                            <div class="col-md-3">
                            ...
                            <button type="submit" name="adcrpbtn" class="btn btn-primary mt-4 pr-4 pl-4" id="adcrpbtn">Add</button>
                          </form>
<!-- ----------------------------------crop add form ends---------------------------------- -->
                        </div>
                      </div>
    ...
    <script src="assets/js/add-crop-validate.js"></script>
