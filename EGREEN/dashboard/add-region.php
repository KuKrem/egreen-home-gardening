<?php 
  ...
  $getdistricts="SELECT * FROM districts WHERE status=1";
  $resdis=mysqli_query($conn, $getdistricts);
?>
<!doctype html>
<html class="no-js" lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/add-region.css">
    <!-- modernizr css -->
          ...
          <div class="menu-inner">
            <nav>
              <ul class="metismenu" id="menu">
                ...
                <li class="active" id="addregionmi">
              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Add Region</h4>
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Insert new region</h4>
...
<!-- ------------------------submission status display messaage------------------------ -->
                          ...
                          <form action="add-region-save.php" method="post" id="adregion" name="addregio">
                            <div class="form-group">
                              <label for="cropname" class="col-form-label">Region name</label>
                              <input class="form-control" type="text" name="regname" id="regid">

                            <div class="col-md-3 col-lg-6">
                              <div class="form-control-feedback">
                                <span id="txtregname"></span>
                              </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="prolist" id="prolistid">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="dislist" id="dislistid">
                                <option value="0">Select</option>
                               
                              </select>
                            </div>

                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" id="addregbtn" name="regadd">Add</button>
                          </form>
                          <!-- Textual inputs end -->
                        </div>
                      </div>
...
<!-- ---------------------------------add region form starts--------------------------------- -->
    ...
    <script src="assets/js/add-region-validate.js"></script>
