...
$getroleamount=mysqli_query($conn, "SELECT role_id,COUNT(role_id) AS count FROM users WHERE role_id=4 OR role_id=7 OR role_id=9 OR role_id=11 OR role_id=12 OR role_id=14 OR role_id=15 OR role_id=16 GROUP BY role_id");
while($row=mysqli_fetch_array($getroleamount)){
 ...
 ?>
    ...
    <script type="text/javascript">
        ...
        var dataset = [{ label: "Shopkeepers in each role id", data: data, color: "#52B640" }];
        // var ticks = [[0, "London"], [1, "New York"], [2, "New Delhi"], [3, "Taipei"],[4, "Beijing"], [5, "Sydney"]];
        // var ticks = [[0, "0"], [1, "4"], [2, "7"], [3, "9"], [4, "11"],[5, "12"], [6, "14"], [7, "15"], [8, "16"]];
        var ticks = [[0, "0"], [1, "-"], [2, "-"], [3, "-"], [4, "4"],[5, "-"], [6, "-"], [7, "7"], [8, "-"], [9, "9"], [10, "-"], [11, "11"], [12, "12"], [13, "-"], [14, "14"], [15, "15"], [16, "16"]];
