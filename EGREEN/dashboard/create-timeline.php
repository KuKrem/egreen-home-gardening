            ...
            <nav>
              <ul class="metismenu" id="menu">
                ...
                <!-- <li class="active"> -->
                  ...
                  <li class="active" id="cretimelinemi">
              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Create Timeline</h4>
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Create new Timeline</h4>
                          <p>You can see crops still haven't timeline from below dropdown menu. If you are able to create a timeline for those select and create.</p>
...
<!-- ------------------------Get crop names to the dropdown starts------------------------ -->
                          <form name="addtl" id="addtline" action="create-tl-save.php" method="post">
                            <div class="form-group">
                              <label class="col-form-label">Select Crop</label>
                              <select class="form-control form-fixer slcrop" name="selectcrop" id="slcrop">
                                <option value="0">Select One</option>
                                <?php 
                                 include('../inc/dbconnection.php');
                                  $query=mysqli_query($conn, "SELECT * FROM crops WHERE timeline_id=0");
                                  if(!$query){
                            ...
                            <button type="submit" id="addtlbtn" name="adtlbttn" class="btn btn-primary mt-4 pr-4 pl-4">Create</button>
                          </form>
<!-- ------------------------Get crop names to the dropdown ends------------------------ -->
    ...
    <script src="assets/js/create-tl-validate.js"></script>
