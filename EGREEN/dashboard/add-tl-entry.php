              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Add Timeline Entry</h4>
                    <ul class="breadcrumbs pull-left">
                      <li><a href="index.php">Dashboard</a></li>
                      <li><span><a href="my-timelines.php">Back to timelines</a></span></li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Selected Timeline</h4>
                            ...
                            <table id="dataTabl" class="text-center table">
                              ...
                              <tbody>
                                <?php
                                  ...
                                  $gettl = "SELECT timelines.*, crops.cropname
                                            FROM timelines
                                            INNER JOIN crops
                                            ON timelines.crop_id = crops.crop_id
                                            WHERE timelines.timeline_id=$_GET[tlid]";
                                  $tls = mysqli_query($conn,$gettl);
                      ...
                      <div class="row">
                        <!-- Textual inputs start -->
                          <div class="col-12 mt-5">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="header-title">Update the selected timeline (Add entries)</h4>

<!-- ------------------------------timeline entry add form starts------------------------------ -->
                                <form id="tlentryform" name="tleform" action="add-tl-entry-save.php" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" id="dayno" name="daynum">
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                      ...
                                      <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="tleimg" id="entryimg">
                                  ...
                                  <div class="form-group">
                                    <input class="form-control" type="hidden" id="tmlnid" name="tmlnid" value="<?php echo $tlid; ?>">
                                  </div>

                                  <button type="submit" id="tladd" name="tlsubmit" class="btn btn-primary mt-4 pr-4 pl-4">Add</button>
                                </form>
<!-- ------------------------------timeline entry add form ends------------------------------ -->   
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Timeline Entry Summary</h4>
                          ...
                          <div class="data-tables datatable-primary">
                            <table id="dataTable4" class="text-center">
                              ...
                              <tbody>
                                <?php
                                  $gettlent = "SELECT * FROM timeline_entries WHERE timeline_id='$tlid' ORDER BY day_no ASC";
                                  $tles = mysqli_query($conn,$gettlent);
                                  foreach ($tles as $index => $tlentries) {
                                ?>
                                <tr>
                                  <td><?php echo $tlentries['created_at'] ?></td>
                                  <td><?php echo $tlentries['day_no'] ?></td>
                                  <td><?php echo $tlentries['description'] ?></td>
                                  <th><img class="imgfrmt" src="<?php echo $tlentries['image'] ?>"> </th>
                                  <td><a href="update-tl-entry.php?tleid=<?php echo $tlentries['tle_id'] ?>"><i class="fa fa-pencil-square-o"></i></a></td>
    ...
    <script src="assets/js/edit-tle-validate.js"></script>
