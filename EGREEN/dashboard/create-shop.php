...
<html class="no-js" lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/create-shop.css">
                ...
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Create The shop</h4>
...
<!-- ------------------------submission status display messaage-------------------------- -->
                          ...
                          <form name="shopcrea" id="shopcrid" method="post" action="create-shop-save.php">

                            <input class="form-control" type="text" name="user" id="userid" value="<?php echo $id ;?>" hidden>

                            <div class="form-group">
                              <label for="cropname" class="col-form-label">Shop name</label>
                              <input class="form-control" type="text" name="shopname" id="shpnmid">
                            </div>

                            <!-- for display error/valid message shop name -->
                            <div class="col-md-3">
                              <div class="form-control-feedback">
                                <span id="txtshpnm"></span>
                              </div>
                            </div>

                            <div class="form-group">
                              <label for="cropname" class="col-form-label">Address</label>
                              <input class="form-control" type="text" name="shopaddrs" id="shpaddrsid">
                            </div>

                            <!-- for display error/valid message shop address -->
                            <div class="col-md-3">
                              <div class="form-control-feedback">
                                <span id="txtshpaddrs"></span>
                              </div>
                            </div>

                            <div class="form-group">
                              <label for="cropname" class="col-form-label">Telephone</label>
                              <input class="form-control" type="text" name="shoptele" id="shptlid">
                            </div>

                            <!-- for display error/valid message shop telephone -->
                            <div class="col-md-3">
                              <div class="form-control-feedback">
                                <span id="txtshptel"></span>
                              </div>
                            </div>

                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="submit" id="creatshpid">Create</button>
                          </form>
                          <!-- Textual inputs end -->
                        </div>
                      </div>
...
<!-- -------------------------------creaye shop form ends------------------------------- -->        
    ...
    <script src="assets/js/create-shop-validate.js"></script>
