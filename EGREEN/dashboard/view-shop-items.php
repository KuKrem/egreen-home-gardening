                ...
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                      ...
                      <li><span><a href="shops.php">Back</a></span></li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="main-content-inner">
              <div class="row">
                <div class="col-lg-6 col-ml-12">
                  ...
                  <!-- selected shop table area starts -->
                  <div class="row">
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Selected shop</h4>

                          <!-- viewing selected shop -->
                          <!-- selected shop viewing table starts -->
                          <div class="data-tables datatable-primary">
                            <table id="dataTab2" class="text-center table">
                              ...
                              <tbody>                               
                                <tr>
                                  <td>Kalyan Chamarika</td>                                  
                                  <td>Seed Hut</td>
                                  <td>No.2, Galle Road, Panadura</td>
                                  <td>0112546789</td>
                                </tr>
                              </tbody>
                            </table>
                  ...
                  <!-- selected shop table area ends -->

                  <!-- shop items table area starts -->
                  <div class="row">
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Shop Items</h4>

                          <!-- viewing shop items of selected shop -->
                          <div class="data-tables datatable-primary">
                            <table id="dataTable2" class="text-center">
                              ...
                              <tbody>                               
                                <tr>
                                  ...
                                  <td>Seed pckt</td>
                                  <td>Rs.30.00/pckt</td>
                                  <td><img src="assets/images/author/author-img1.jpg"></td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
