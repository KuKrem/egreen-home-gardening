              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">I Helper</h4>
              ...
              <div class="row">
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <!-- i helper detail table starts -->
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">I Helper</h4>
                            ...
                            <table id="dataTab2" class="text-center table">
                              ...
                              <tbody>                                
                                <tr>
                                  ...
                                  <td><a href=""><i class="fa fa-pause"></i></a></td>
                                </tr>                               
                              </tbody>
                            </table>
                          </div>
