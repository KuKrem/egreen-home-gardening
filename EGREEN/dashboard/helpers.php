              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Helpers</h4>
              ...
              <div class="row">
                <div class="col-lg-6 col-ml-12">
                  <div class="row">
                    ...
                    <!-- helpers list table starts -->
                    <div class="col-12 mt-5">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="header-title">Helpers</h4>
                            ...
                            <table id="dataTable2" class="text-center">
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  $gethelpers="SELECT U.fname, U.lname, U.profile_image, U.tel, R.town, P.pro_name, D.dis_name FROM users U, regions R, provinces P, districts D WHERE U.region_id=R.region_id AND R.district_id=D.district_id AND R.province_id=P.province_id";
                                  $helpers = mysqli_query($conn,$gethelpers);
                                  foreach ($helpers as $index => $helper) {
                                 ?>                               
                                <tr>
                                  <td><?php echo ++$index ?></td>
                                  <td><?php echo $helper['fname']." ".$helper['lname']; ?></td>              
                                  <td><img src="../<?php echo $helper['profile_image']; ?>" alt="" width=80px></td>
                                  <td><?php echo $helper['tel']; ?></td>
                                  <td><?php echo $helper['pro_name']."/".$helper['dis_name']."/".$helper['town']; ?></td>
                                </tr>
                                <?php } ?>                              
                              </tbody>
                            </table>
