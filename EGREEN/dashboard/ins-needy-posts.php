...
<html class="no-js" lang="en">
  ...
  <head>
    ...
    <title>Instruction Needy Posts</title>
              ...
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Instruction Needy Posts</h4>
              ...
              <div class="row">
                <div class="col-lg-8 offset-lg-2 mt-5">
                    ...
                    <div class="card-body">
                      <div class="media mb-5">
                        ...
                        <div class="media-body">
                          <h4 class="mb-3">Kalyan Chamarika</h4> 
                          5 hours ago
                        </div>
                      </div>
                      <div class="media">
                        <img class="img-fluid mr-4" src="../images/Girl-Ladybug-and-Teacher.jpg" width="300px" alt="">
                      </div>
                      <div class="media-body">
                  ...
                  <div>
                    ...
                    <button type="button" class="btn btn-success btn-lg btn-block">All comments - 12</button>
                  </div>
                </div>
              </div>
<!-- ----------------------------------first post ends---------------------------------- -->
              ...
              <div class="row">
                <div class="col-lg-8 offset-lg-2 mt-5">
                  <div class="card">
                    <div class="card-body">
                      <div class="media mb-5">
                        <img class="img-fluid mr-4" src="../images/user.png" width="80px" alt="image">
                        <div class="media-body">
                          <h4 class="mb-3">Jayana Prashadini</h4> 
                          6 hours ago
                        </div>
                      </div>
                      <div class="media">
                        <img class="img-fluid mr-4" src="../images/01215656.jpg" width="300px" alt="">
                      </div>
                      <div class="media-body">
                        <h4 class="mb-3">Description</h4>
                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                  ...
                  <div>
                    ...
                    <button type="button" class="btn btn-info btn-lg btn-block">Submit</button>
                    <button type="button" class="btn btn-success btn-lg btn-block">All comments - 15</button>
                  </div>
                </div>
              </div>
<!-- ----------------------------------second post ends---------------------------------- -->
