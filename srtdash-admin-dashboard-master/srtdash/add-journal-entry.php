...
<html class="no-js" lang="en">
  ...
  <body>
                              ...
                              <div class="card-body">
                                ...
                                <form>
                                  ...
                                  <div class="form-group">
                                    <label for="example-text-input" class="col-form-label">Number of plants/seeds</label>
                          ...
                          <div class="data-tables datatable-primary">
                            <table id="dataTable2" class="text-center">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td>2019:02:05 13:48</td>
                                  <td>8</td>
                                  <td>Yes</td>
                                  <td>No</td>
                                  <td>Two are 2cm. 1 is 3cm.</td>
                                  <th><img src="assets/images/author/author-img1.jpg"> </th>
    ...
    <script src="assets/js/ajentry.js"></script>
